    ...
    const fetchUserProfileAndPosts = async () => {
      if (!otherUserId) {
        return (
          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>Error: User ID not provided.</Text>
          </View>
        );
      }
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          // Fetch posts if the account is public or if the current user is following
              ...
              <Image
                source={
                  profileData.profilePictureUrl
                    ...
                    : require('../../assets/blank-profile-picture.webp') // Placeholder image
                }
